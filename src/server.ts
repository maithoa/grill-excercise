...
export function createApp(rateLimiter: RequestHandler = loginRateLimiter) {
    const app = express();
    const port = 3000;
    ...
    app.post('/api/customer/login', rateLimiter, async (req: Request, res: Response) => {
    ...
    app.post('/api/internal/login', rateLimiter, async (req: Request, res: Response) => {
